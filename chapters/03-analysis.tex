...
\label{ch:analysis}
Bevor mit dem Entwurf des Konzepts und der Implementierung der Anwendung begonnen werden kann, muss die Ist-Situation anlysiert werden.
...
Die Beziehungen zwischen den Objekten, wie sie im \acf{imdf} gewollt sind, können nicht sehr gut abgebildet werden.
