...
Für den Fall, dass der ``Assembler`` zwei Koordinaten kennt eine \texttt{MKPolyline} als Overlay erzeugt wird (Zeile 8).
In Zeile 13 wird dann der soeben erstellte Overlay angezeigt, wobei das alte gelöscht und das neue gezeichnet wird.
...
Mittels \emph{Autolayout} wird dafür gesorgt, dass die Elemente auf dem Bildschirm sich automatisch der Bildschirmgröße anpassen, sodass eine visuell ansehnliche Darstellung der Anwendung auf jedem Gerät erreicht wird.
